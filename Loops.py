...
For Loops
 ...
 #for loops is interating over a sequence
...
fruits = ["appple", "banana", "orange", "pineapple", "coconut", "cucumber"]
for x in fruits:
	print(x)
	if x == "pineapple":
		break
...
#The range() Function - a set of code a specified number of time
